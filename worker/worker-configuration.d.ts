/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: ca4bbd1445d14a6e5fec0a6f20a1aeed)
...
interface __BaseEnv_Env {
	...
	ACCESS_AUD: "unconfigured-fail-closed";
